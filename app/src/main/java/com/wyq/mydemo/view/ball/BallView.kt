 ...
 * Description:
 */
class BallView(context: Context, attributeSet: AttributeSet?, defStyleAttr: Int) :
    ...
    private fun initView(contet: Context, attributeSet: AttributeSet?) {
    ...
    override fun onTouchEvent(event: MotionEvent?): Boolean {
        ...
        val path = Path().apply {
            ...
            quadTo(lastTouchEventX,lastTouchEventY,touchEventX,touchEventY)
        }
